...
This is a simple script to download all [MDV](https://www.mdv.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"10756","Leipzig, Holsteinstr.",12.411406,51.331103,""
```
